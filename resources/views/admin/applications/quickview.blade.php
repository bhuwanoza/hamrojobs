                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table">
                                        ...
                                        @isset($user->jobseeker->additional)
                                            ...
                                            <tr>
                                                <td>Specialization<span class="float-right">:</span>
                                                </td>
                                                <td>
                                                    <span class=" badge cyan">{{ $user->jobseeker->additional->specialization }}</span>
                                                </td>
                                            </tr>
                                        @endisset
                                    </table>
                                        ...
                                        @foreach($user->jobseeker->experiences as $experience)
                                            <div class="card m-2">
                                                ...
                                                <span class="font-md">
                                                    ...
                                                    <h6 class="text-muted">
                                                        <i class="fas fa-location-arrow"></i> {{ $experience->organization_title }}
                                                    </h6>
                                                    <h6 class="text-muted">
